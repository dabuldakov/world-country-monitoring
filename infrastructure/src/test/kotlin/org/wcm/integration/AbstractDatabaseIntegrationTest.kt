...
abstract class AbstractDatabaseIntegrationTest {
    ...
    fun clearPopulation() {
        ...
        jdbcTemplate.update("TRUNCATE TABLE life_expectancy RESTART IDENTITY")
        jdbcTemplate.update("TRUNCATE TABLE gross_domestic_product_per_capita RESTART IDENTITY")
